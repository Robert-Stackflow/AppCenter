...
footer:
  ...
  bdageitem:
    ...
    - link: https://blog.anheyu.com/
      shields: https://pan.anheyu.com/d/anzhiyu/svg/Theme-Cloudchewie-2E67D3.svg
      message: 本站使用Cloudchewie主题
...
以下的写法，只适用于 Cloudchewie 主题，用在其它主题上不会有效果，甚至可能会报错。使用前请留意
:::
...
PWA是web优化的一种手段，主题做了一定的适配，但是依然需要进行配置。要为Cloudchewie配上 PWA 特性, 你可以进行选择以下两种方式来进行适配，`hexo-offline`适合初学者，`hexo-swpp`适合已经对`service worker`有一定解决问题能力的进阶使用。
